...
try:
    ...
    print(f'A média etária do grupo é {media}, o homem mais velho é {nome_mais_velho} e o '
          f'grupo possui {compatibilidade} mulheres com menos de 20 anos.')

except ValueError:
    print('Insira apenas números inteiros na idade.')
